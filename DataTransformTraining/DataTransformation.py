...
class DataTransform:
    ...
    def __init__(self):
        self.GoodDataPath="C:/Users/malik/PycharmProjects/wafer_project/Training_Raw_files_validated/Good_Raw"
    ...
    def ReplaceMissingValuesWithNull(self):
        '''
                             ...
                             Revision:None
                                     ...
                                     '''
        try:
            file=open("C:/Users/malik/PycharmProjects/wafer_project/Training_log/DataTransforming.txt",'a+')
