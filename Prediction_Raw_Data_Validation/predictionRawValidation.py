...
class Prediction_Data_Validation:
    def __init__(self,path):
        ...
        self.schema_path= "C:/Users/malik/PycharmProjects/wafer_project/schema_prediction.json"
    ...
    def Values_from_schema(self):
        ...
        try:
            ...
            file = open("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Logs/ValuesFromSchemaValidationLog.txt",'a+')
    ...
    def createDirectoryForGoodBadRawData(self):
        ...
        try:
            path = os.path.join("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated","/Good_Raw/")
            if not os.path.isdir(path):
                os.makedirs(path)
            path = os.path.join("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated", "/Bad_Raw/")
            if not os.path.isdir(path):
                os.makedirs(path)

        except OSError as ex:
            file=open('C:/Users/malik/PycharmProjects/wafer_project/Prediction_Logs/GeneralLog.txt','a+')
    ...
    def deleteExistingBadDataPredictionFolder(self):
        ...
        try:
            path="C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/"
            ...
            file=open("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Logs/GeneralLog.txt",'a+')
            self.logger.log(file,"Error Occurred while deleting the directory: %s"%s)
            file.close()
            raise OSError
    ...
    def MovingBadFilesToArchive(self):
        ...
        try:
            ...
            source="C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/Bad_Raw"
            if os.path.isdir(source):                 # if source is an existing directory then
                path="C:/Users/malik/PycharmProjects/wafer_project/PredictionArchiveBadData"    # stores the path of Archive folder into the Path variable
                if not os.path.isdir(path):           # if path is not an existing directory then
                    os.makedirs(path)                 # make the directory for path
                dest="C:/Users/malik/PycharmProjects/wafer_project/PredictionArchiveBadData/BadData_"+str(date)+"_"+str(time)  # dest =BadData_date_time folder path
                ...
                log_file=open("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Logs/GeneralLog.txt",'a+')
                self.logger.log(log_file,"Bad files moved to Archive")
                #removing the Bad_Raw folder
                path="C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/Bad_Raw/"
    ...
    def ValidationFileNameRaw(self,regex,LengthOfDateStampFile,LengthOfTimeStampFile):
        ...
        try:
            ...
            try:
                file=open("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Logs/NameValidationLog.txt",'a+') # opening a log file--NameValidationLog.txt
                    ...
                    if re.match(regex,filename):    # if regex and filename matches then...
                        ...
                        if len(splitAt_[1])==LengthOfDateStampFile:     # if length of LengthOfDateStampFile matches
                            if len(splitAt_[2])==LengthOfTimeStampFile:  # if length of LengthOfTimeStampFile matches
                                ...
                                shutil.copy("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Batch_files/"+filename,"C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/Good_Raw")
                                ...
                                shutil.copy("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Batch_files/" + filename,"C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/Bad_Raw")
            ...
            file=open("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Logs/NameValidationLog.txt",'a+')
    ...
    def ValidateColumnLength(self,NumberOfColumns):
        ...
        try:
            ...
            file=open("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Logs/columnValidatingLog.txt",'a+')
            self.logger.log(file,"Validation for number of columns started!!!")
            for file in os.listdir("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/"+"Good_Raw/"):    # looping over the files stored in Good Raw folder
                csv=pd.read_csv("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/"+"Good_Raw/"+file)   # reading the path for .csv file
                if csv.shape[1]==NumberOfColumns:                                 # if the no of columns i.e csv.shape[1] matches with NumberOfColumns then do nothing
                    ...
                    shutil.move("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/"+"Good_Raw/"+file,"C:/Users/malik/PycharmProjects/wafer_project/Prediction_Raw_files_validated/Bad_Raw")
    ...
    def delete_prediction_file(self):
        if os.path.exists("C:/Users/malik/PycharmProjects/wafer_project/PredictionOutputFile/Prediction.csv"):
            os.remove("C:/Users/malik/PycharmProjects/wafer_project/PredictionOutputFile/Prediction.csv")
    ...
    def ValidatingMiisingValuesInWholeColumn(self):
        ...
        try:
            file=open("C:/Users/malik/PycharmProjects/wafer_project/Prediction_Logs/MissingValueInColumn.txt",'a+')
